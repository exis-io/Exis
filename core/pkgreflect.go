...
var Functions = map[string]reflect.Value{
	...
	"SetAuthenticationOff": reflect.ValueOf(SetAuthenticationOff),
	"SetAuthenticationOn": reflect.ValueOf(SetAuthenticationOn),
	...
	"SetFabric": reflect.ValueOf(SetFabric),
...
var Variables = map[string]reflect.Value{
	...
	"HardAuthentication": reflect.ValueOf(&HardAuthentication),
